...
\includepdf[addtotoc={1, subsubsection, 1, Poster,P24}]{Posters/P24Parajka.pdf}
...
\includepdf[pages = -, addtotoc={1, subsubsection, 1, Short article,A29}]{ShortArt/P29Clementetal.pdf}
...
\includepdf[pages = -, addtotoc={1, subsubsection, 1, Short article,A30}]{ShortArt/P30KerekSzam.pdf}
