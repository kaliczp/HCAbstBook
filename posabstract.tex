...
\phantomsection
\stepcounter{articleid}
\addcontentsline{toc}{subsection}{Paulíková. ﻿Selection of the peak runoff coefficient estimation method for the Horné Orešany – Parná case study (Slovakia)}
\begin{flushleft}

\abstrtitle{﻿Selection of the peak runoff coefficient estimation method for the Horné Orešany – Parná case study (Slovakia)}

\name{Lynda Paulíková$^1$}
